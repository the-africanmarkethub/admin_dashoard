...
import { getTickets } from "../../lib/api_/tickets";
                ...
                {statusTabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`inline-flex items-center gap-2 px-12 py-2 text-sm font-medium border-b-2 ${
                                isActive
